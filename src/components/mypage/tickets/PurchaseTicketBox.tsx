  ...
  return (
    <EventInfoBox>
      <Link
        ...
        className='mb-1 w-fit break-keep text-xl font-semibold tablet:text-lg mobile:text-base'
      >
        {event.name}
      </Link>

      <div className='mt-5 flex items-end justify-between tablet:mt-3 mobile:flex-col mobile:items-start mobile:gap-6'>
        <div className='flex flex-col gap-2 tablet:gap-1'>
