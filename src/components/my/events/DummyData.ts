...
export const eventDummyData: EventType[] = [
  {
    ...
    endDateTime: Timestamp.fromDate(new Date('2024-08-10T17:00:00Z')),
    registrationStart: Timestamp.fromDate(new Date('2024-04-01T00:00:00Z')),
    registrationEnd: Timestamp.fromDate(new Date('2024-08-01T23:59:59Z')),
    location: '서울 강남구 삼성동',
    description:
    ...
    eventCreationDate: Timestamp.fromDate(new Date('2024-04-01T12:00:00Z')),
  },
  {
    uid: 'event2',
    organizerUID: 'wflEa2XfzgOLRRXuGdmXpB6h7HW2',
    ...
    endDateTime: Timestamp.fromDate(new Date('2024-09-15T16:00:00Z')),
    registrationStart: Timestamp.fromDate(new Date('2024-07-01T00:00:00Z')),
    registrationEnd: Timestamp.fromDate(new Date('2024-09-10T23:59:59Z')),
    location: '서울 중구',
    description:
    ...
    eventCreationDate: Timestamp.fromDate(new Date('2024-06-20T12:00:00Z')),
  },
  {
    uid: 'event3',
    organizerUID: 'wflEa2XfzgOLRRXuGdmXpB6h7HW2',
    ...
    endDateTime: Timestamp.fromDate(new Date('2024-10-05T18:00:00Z')),
    registrationStart: Timestamp.fromDate(new Date('2024-08-01T00:00:00Z')),
    registrationEnd: Timestamp.fromDate(new Date('2024-09-30T23:59:59Z')),
    location: '서울 성동구',
    description:
    ...
    eventCreationDate: Timestamp.fromDate(new Date('2024-07-15T12:00:00Z')),
  },
  {
    uid: 'event4',
    organizerUID: 'wflEa2XfzgOLRRXuGdmXpB6h7HW2',
    ...
    endDateTime: Timestamp.fromDate(new Date('2024-11-20T17:00:00Z')),
    registrationStart: Timestamp.fromDate(new Date('2024-09-01T00:00:00Z')),
    registrationEnd: Timestamp.fromDate(new Date('2024-11-15T23:59:59Z')),
    location: '인천 연수구',
    description:
    ...
    eventCreationDate: Timestamp.fromDate(new Date('2024-08-01T12:00:00Z')),
  },
  {
    uid: 'event5',
    organizerUID: 'wflEa2XfzgOLRRXuGdmXpB6h7HW2',
    ...
    endDateTime: Timestamp.fromDate(new Date('2024-07-15T18:00:00Z')),
    registrationStart: Timestamp.fromDate(new Date('2024-05-15T00:00:00Z')),
    registrationEnd: Timestamp.fromDate(new Date('2024-07-10T23:59:59Z')),
    location: '서울 서초구',
    description:
    ...
    eventCreationDate: Timestamp.fromDate(new Date('2024-04-30T12:00:00Z')),
  },
  {
    uid: 'event6',
    organizerUID: 'wflEa2XfzgOLRRXuGdmXpB6h7HW2',
    ...
    endDateTime: Timestamp.fromDate(new Date('2024-10-05T16:00:00Z')),
    registrationStart: Timestamp.fromDate(new Date('2024-08-01T00:00:00Z')),
    registrationEnd: Timestamp.fromDate(new Date('2024-10-01T23:59:59Z')),
    location: '부산 해운대구',
    description:
    ...
    eventCreationDate: Timestamp.fromDate(new Date('2024-07-01T12:00:00Z')),
  },
];
